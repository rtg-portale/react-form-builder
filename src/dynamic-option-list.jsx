          ...
          <li>
            <div className="row">
              <div className="col-sm-6">
                <b>{translate('edit.dropdown-options')}</b>
              </div>
              <div className="col-sm-2">
                <b>{translate('edit.dropdown-value')}</b>
              </div>
              <div className="col-sm-4">
                <b>{translate('edit.dropdown-correct')}</b>
              </div>
            </div>
          </li>
                ...
                <div className="row">
                  <div className="col-sm-6">
                    <input
                      ...
                      type="text"
                      name={`text_${index}`}
                      placeholder={translate('edit.dropdown-placeholder')}
                      value={option.text}
