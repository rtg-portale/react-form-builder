      ...
      <div>
        ...
        {this.props.element.hasOwnProperty('content') && (
          <div className="form-group">
            <label className="control-label">{translate('edit.text-to-display')}</label>
        ...
        {this.props.element.hasOwnProperty('label') && (
          <div className="form-group">
            <label>{translate('edit.display-label')}</label>
            <Editor
              toolbar={toolbar}
              defaultEditorState={editorState}
              onBlur={this.updateElement.bind(this)}
            ...
            {this.props.element.hasOwnProperty('defaultToday') && (
              <div className="checkbox">
                <label>
                  ...
                  {translate('edit.default-to-today')}
                </label>
              </div>
            )}
            {(this.state.element.element === 'RadioButtons' || this.state.element.element === 'Checkboxes') && (
              <div className="checkbox">
                <label>
                  ...
                  {translate('edit.display-horizontal')}
                </label>
              </div>
            )}
          </div>
        ...
        {this.state.element.element === 'Signature' && this.props.element.readOnly ? (
          <div className="form-group">
            ...
            />
            <p className="help-block">{translate('edit.variable-key-help')}</p>
          </div>
        ) : (
          <div />
        )}
        ...
        <div className="form-group">
          <label className="control-label">{translate('edit.print-options')}</label>
          <div className="checkbox">
            <label>
              ...
              {translate('edit.page-break')}
            </label>
          </div>
        </div>

        <div className="form-group">
          <label className="control-label">{translate('edit.alternate-signature-page')}</label>
          <div className="checkbox">
            <label>
              ...
              {translate('edit.alternate-signature-page-desc')}
            </label>
          </div>
        </div>
          ...
          <div className="form-group">
            <div className="form-group-range">
              <label className="control-label" htmlFor="defaultSelected">
                {translate('edit.default-selected')}
              </label>
              <input
                id="defaultSelected"
                type="number"
        ...
        {this.props.element.hasOwnProperty('static') &&
          this.props.element.static && (
            <div className="form-group">
              <label className="control-label">{translate('edit.text-style')}</label>
              <div className="checkbox">
                <label>
